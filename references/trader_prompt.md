...
| 研究经理决策 | 交易员行动 |
|-------------|-----------|
| 买入 | buy_price/target_price/stop_loss 必填，position_size="15%-20%" |
| 增持 | buy_price/target_price/stop_loss 必填，position_size="15%-20%" |
| 持有 | buy_price=null, position_size="0%" |
| 减持 | buy_price=null, position_size="0%" |
| 卖出 | buy_price=null, position_size="0%" |
