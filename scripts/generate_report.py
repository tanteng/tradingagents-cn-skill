...
def main():
    ...
    # Normalize risk_debate: data_schema uses "neutral" but skill prompts may output "moderate"
    if "risk_debate" in data and "moderate" in data["risk_debate"]:
        data["risk_debate"]["neutral"] = data["risk_debate"].pop("moderate")
